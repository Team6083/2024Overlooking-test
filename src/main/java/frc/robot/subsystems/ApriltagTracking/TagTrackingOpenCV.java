...
// public class TagTrackingOpenCV implements Runnable {

//   boolean CrescendoTagLayout = false; // false is use custom deploy of layout

//   public void run() {
//     System.out.println("ApriltagVisionThreadProc");

//     var detector = new AprilTagDetector();
//     // look for tag36h11, don't correct any error bits
...
//       {
//         System.out.format("%s %6.1f, %6.1f, %6.1f [degrees]%n", // %s = string, %6.1f means the float should have one decimal and 6 place?, %n means change to next line
//               tag.toString(),
...
//     /*
// 8 Tags on file // this is charge up 2023, go online to search for 2024 crescendo
...
//         // originally not commented bext line
...
//         // originally not commented next line
